...
\begin{figure}[hp]
	\centering
		\includegraphics[width=1.00\textwidth]{./figures/gesamtaufbau.png}
		\caption{Gesamtaufbau}
	\label{fig:gesamtaufbau}
\end{figure}

\begin{figure}[hp]
	\includegraphics[width=1.00\textwidth]{./figures/linux2linux.png}
	\caption{Linux2linux}
	\label{fig:linux2linux}
\end{figure}

\begin{figure}[hp]
	\centering
		\includegraphics[width=1.00\textwidth]{./figures/linux2rs323.png}
	\caption{l2r}
	\label{fig:linux2rs323}
\end{figure}
